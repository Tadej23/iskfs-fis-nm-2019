...
http.createServer(function(req, res){ // http.createServer([requestListener])
    ...
    res.write("LED 1 OFF: http://192.168.1.123:8080/0<br>");
	res.write("LED 1 ON : http://192.168.1.123:8080/1<br>");
	res.write("LED 2 OFF: http://192.168.1.123:8080/2<br>");
	res.write("LED 2 ON : http://192.168.1.123:8080/3<br>");
    res.end("Vrednost operatorja: " + operator);
}).listen(8080, "192.168.1.123");